...
Versão 1.1-beta - Sistema de configuração centralizado e otimizado
"""
...
class Config:
    ...
    SECRET_KEY = os.environ.get('SECRET_KEY', 'snaplinked-secret-key-2025-v1.1-beta')
    ...
    LINKEDIN_REDIRECT_URI = os.environ.get('LINKEDIN_REDIRECT_URI', 'https://snaplinked.com/auth/linkedin/callback')
